...
export function InventoryFilters({
    ...
    return (
        <div className="bg-white dark:bg-stone-900 rounded-lg border border-stone-200 dark:border-stone-800 shadow-sm transition-all mt-4 overflow-hidden">
            {/* Main Filter Row */}
            <div className="flex flex-col xl:flex-row gap-4 xl:items-end p-4">
