...
export default function SanxuatCategoriesPage() {
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-2xl font-bold text-stone-800">Danh mục Dữ liệu dùng chung</h1>
                    <p className="text-stone-500 text-sm mt-1">Phân mục dữ liệu kết nối linh kiện và sản phẩm</p>
                </div>
                {/* For production, they might just view or manage categories, using manage permission */}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full p-3 rounded-xl bg-white border border-stone-200 text-stone-800 placeholder:text-stone-400 focus:outline-none focus:border-emerald-400 focus:ring-2 focus:ring-emerald-100"
            ...
            <div className="bg-white rounded-2xl p-4 border border-stone-200">
                <div className="relative max-w-md">
                    ...
                    <input
                        ...
                        className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-stone-50 border border-stone-200 text-stone-800 placeholder:text-stone-400 focus:outline-none focus:border-emerald-400 focus:ring-2 focus:ring-emerald-100"
                    />
                </div>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-stone-200 overflow-hidden">
                {loading ? (
                    ...
                    <div className="p-8 text-center text-stone-500">
                        <FolderTree className="mx-auto mb-3 opacity-30 text-emerald-500" size={48} />
                                    ...
                                    <td className="px-5 py-4">
                                        {editingId === cat.id ? (
                                            <input
                                                ...
                                                className="w-full p-2 rounded-lg border border-emerald-300 focus:outline-none focus:ring-2 focus:ring-emerald-100"
                                                autoFocus
                                            />
                                        ) : (
                                                ...
                                                <>
                                                    <Protected permission="category.manage">
                                                        <button
                                                            ...
                                                            className="p-2 rounded-lg text-stone-500 hover:bg-emerald-50 hover:text-emerald-600 transition-colors"
                                                        >
                                                            <Edit size={16} />
                                                        </button>
                                                        <button
