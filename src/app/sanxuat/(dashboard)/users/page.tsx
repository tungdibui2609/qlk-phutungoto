...
export default function SanxuatUsersPage() {
    ...
    async function fetchUsers() {
        ...
        let query = supabase
            ...
            .contains('allowed_systems', ['SANXUAT'])
            .order('full_name')
        ...
        <div className="space-y-5">
            ...
            <div className="bg-white rounded-xl p-4 border border-stone-200 flex flex-col md:flex-row items-center gap-4">
                <div className="relative flex-1 w-full md:max-w-md">
                    ...
                    <input
                        ...
                        className="w-full pl-9 pr-4 py-2 rounded-lg bg-stone-50 border border-stone-200 text-sm text-stone-800 placeholder:text-stone-400 focus:outline-none focus:border-emerald-400 focus:ring-2 focus:ring-emerald-100"
                    />
                </div>
                <select
                    value={filterRole}
                    onChange={(e) => setFilterRole(e.target.value)}
                    className="w-full md:w-auto px-3 py-2 rounded-lg bg-stone-50 border border-stone-200 text-sm text-stone-700 focus:outline-none focus:border-emerald-400"
                >
            ...
            {loading ? (
                ...
                <div className="bg-white rounded-xl border border-stone-200 p-8 text-center text-stone-500">
                    <Users className="mx-auto mb-2 opacity-30 text-emerald-500" size={40} />
                    <p className="text-sm">Chưa có người dùng nào thuộc hệ thống Sản Xuất</p>
                </div>
            ) : (
                <>
                                            ...
                                            {user.email ? (
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <button
                                                        ...
                                                        className="text-stone-400 hover:text-emerald-500 transition-colors p-1 rounded-md hover:bg-emerald-50"
