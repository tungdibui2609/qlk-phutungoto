...
import { Settings, Plus, X, Save, Trash2, PackageOpen, ChevronLeft, ChevronRight, RefreshCw, AlertTriangle } from 'lucide-react'
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-sm text-stone-500 dark:text-stone-400 mt-1">
                        Cấu hình sản phẩm giao/nhận cho từng lệnh sản xuất
                    </p>
                </div>
                <button
                    onClick={loadMOList}
