...
export default function OutboundPage() {
    ...
    const updateBufferCount = async () => {
        ...
        data?.forEach((lot: any) => {
            ...
            const rawExports = history.exports || []
            const rawSyncExports = history.accounting_sync?.exports || []

            const exports = [
                ...(Array.isArray(rawExports) ? rawExports : [rawExports]),
                ...(Array.isArray(rawSyncExports) ? rawSyncExports : [rawSyncExports])
            ]
        ...
        <div className="p-6 space-y-6">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-gray-500">Xem và quản lý các phiếu xuất kho trong hệ thống</p>
                </div>
