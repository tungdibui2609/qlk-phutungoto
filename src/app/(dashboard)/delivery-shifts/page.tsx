...
import { Factory, Calendar, Clock, User, CheckCircle2, XCircle, AlertTriangle, FileText, ArrowLeft, RefreshCw, BarChart3, TrendingUp, Package, Shield, Layers, HelpCircle, Trash2 } from 'lucide-react'
                    ...
                    {selectedShift ? (
                        <div>
                            ...
                            <div className="p-4 md:p-6">
                                <h3 className="font-bold text-sm mb-4 flex items-center gap-1.5"><BarChart3 size={16} className="text-orange-500" /> Tổng hợp số liệu giao nhận</h3>
                                {(() => {
                                        ...
                                        return (
                                            <div className="mb-6">
                                                <h4 className="text-xs font-bold text-stone-400 uppercase tracking-wider mb-2.5 flex items-center gap-1.5">
                                                    <Layers size={13} className="text-orange-500" /> Đối soát chi tiết theo Lệnh sản xuất (MO)
                                                </h4>
                                                <div className="space-y-4">
                                                    {Object.entries(moSummaryData).map(([moCode, moData]: any) => (
                                                        <div key={moCode} className="bg-stone-50/50 dark:bg-zinc-900/50 border border-stone-200/50 dark:border-zinc-700/50 rounded-xl p-3 shadow-sm">
                                                            <div className="text-xs font-black text-indigo-650 dark:text-indigo-400 mb-2 flex items-center justify-between">
