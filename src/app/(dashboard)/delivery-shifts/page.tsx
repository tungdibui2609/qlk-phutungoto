...
import { Factory, Calendar, Clock, User, CheckCircle2, XCircle, AlertTriangle, FileText, ArrowLeft, RefreshCw, BarChart3, TrendingUp, Package, Shield, Layers, HelpCircle } from 'lucide-react'
                    ...
                    {selectedShift ? (
                        <div>
                            ...
                            <div className="p-4 md:p-6">
                                <h3 className="font-bold text-sm mb-3 flex items-center gap-1.5"><BarChart3 size={16} className="text-orange-500" /> Tổng hợp số liệu giao nhận</h3>
