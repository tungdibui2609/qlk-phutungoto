const fs = require('fs');
const url = 'https://viqeyhpnevxcowsffueb.supabase.co/rest/v1/lots?code=eq.DL-LOT-280226-010';
const headers = {
...
fetch(url, { headers })
    .then(r => r.json())
    .then(data => fs.writeFileSync('result_utf8.json', JSON.stringify(data, null, 2), 'utf8'))
    .catch(console.error);
