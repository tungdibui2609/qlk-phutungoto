-- migration: 20260325000004_add_tag_to_production_loans.sql
-- Add tag column to production_loans to store the specific tag used during allocation

ALTER TABLE public.production_loans
ADD COLUMN IF NOT EXISTS tag TEXT;

COMMENT ON COLUMN public.production_loans.tag IS 'Mã phụ (Tag) của vật tư tại thời điểm cấp phát';

-- Update the FIFO RPC to store the tag
