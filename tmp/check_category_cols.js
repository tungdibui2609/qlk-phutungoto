...
async function run() {
    try {
        ...
        // Fetch first category to see columns
        const cats = await request('/categories?select=*&limit=1');
        console.log('Category columns:', Object.keys(cats[0]));
        console.log('Category data:', cats[0]);
