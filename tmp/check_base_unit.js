...
async function run() {
    try {
        const pid = 'b406fdcc-da1e-407f-8209-1153ea73d798';
        const p = await request(`/products?id=eq.${pid}&select=name,unit`);
        console.log(`Product: ${p[0].name} | Base Unit: ${p[0].unit}`);
    } catch (e) {
