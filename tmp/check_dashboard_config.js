...
async function run() {
    try {
        console.log('--- CHECKING IF "dashboard_config" TABLE EXISTS ---');
        const check = await request('/dashboard_config?limit=1');
        console.log('dashboard_config:', check ? 'Exists' : 'Not found');
